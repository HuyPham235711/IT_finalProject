...
CHECKPOINT_PATH = "results/lstm_advanced/v3/att_cnn_lstm_v3.pt"
...
def main():
    print("=== ATT-CNN-LSTM v3 BACKTEST (MULTI-PART) ===")
    ...
    for part, table in BACKTEST_PARTS.items():
        ...
        out_path = OUT_DIR / f"att_cnn_backtest_embeddings_v3_{part}.npy"
